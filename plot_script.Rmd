---
title: "Plots for vaccine equity in Ethiopia analysis"
output: pdf_document
---
...
Inequities in vaccination coverage in Ethiopia associated with socioeconomic, geographic, maternal and child characteristics. 

```{r coverage, warning = F}
